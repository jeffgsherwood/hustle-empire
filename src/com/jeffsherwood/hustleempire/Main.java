...
public class Main {
 ...
 public static void main(String[] args) {
     ...
     while (playAgain) {
         ...
         // will handle assigning the correct name (either user input or a generated "HustlerXXX").
         Player player = new Player(playerNameInput, STARTING_BANKROLL, 0, 0); // Temporary 0,0 for skills, will be set after allocation
         ...
         // Update player skills after allocation loop
